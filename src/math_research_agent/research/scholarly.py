...
class _CachedJSONProvider:
    ...
    def __init__(
        ...
        *,
        ...
        user_agent: str = "Math Research Agent-ScholarlyAdapter/1.0 (public metadata only)",
    ):
        ...
        *,
        ...
        status, headers, body = self.request_fn(
            url,
            {
                ...
                "User-Agent": "Math Research Agent-FullTextRetriever/1.0",
            },
            self.timeout,
        )
        if status == 429 or status >= 500:
                ...
                item.update(
                    {
                        ...
                        "extractor_version": "math_research_agent-theorem-span-v1",
                    }
                )
            extraction_payload = {
                "schema_version": 1,
