...
from math_research_agent.research.architecture_critic import evaluate_patch
from math_research_agent.research.architecture_patch import (
    ArchitecturePatch,
    PatchObligationAddition,
    ScopeTransfer,
)
from math_research_agent.research.architecture_review import (
    ArchitectureDimension,
    ArchitectureDimensionFinding,
    ArchitectureReview,
    GovernanceActor,
)
from math_research_agent.research.campaign import CampaignStore
...
from math_research_agent.research.structural_effect import StructuralEffect
from math_research_agent.research.structural_probe import (
    ProbeBudget,
    StructuralProbe,
    StructuralProbePlan,
)
