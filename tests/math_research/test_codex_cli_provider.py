...
from math_research_agent.research.codex_cli_provider import (
    BILLING_MODE,
    CodexCLIClient,
...
from math_research_agent.research import cli
from math_research_agent.research.providers import create_client, load_model_config
...
def test_codex_factory_does_not_construct_openai_provider(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "math_research_agent.research.providers.OpenAIResponsesClient",
        fail_openai,
    )
