...
from math_research_agent.core.scope import submission_blocker
...
def test_closed_scope_gap_allows_submission():
    ...
    assert submission_blocker(whiteboard) is None


def test_unrelated_whiteboard_does_not_block_submission():
    assert submission_blocker("Low branch checked; no gaps.") is None
