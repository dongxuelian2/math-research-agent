...
commands are routed by ``python -m openprover.math_research`` so campaign
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m openprover.math_research",
        description="OpenProver Research Harness v2 campaign commands",
    )
