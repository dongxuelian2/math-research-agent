...
from openprover.math_research.claim_snapshot import SnapshotComparison
from openprover.math_research.orchestrator import ResearchOrchestrator
from openprover.math_research.phase7 import Phase7Error, Phase7Store
...
def test_phase7_normal_path_persists_and_resumes(tmp_path):
    ...
    assert b"OPENPROVER_PHASE7_FINAL_CONSOLIDATION" in proof_path.read_bytes()
